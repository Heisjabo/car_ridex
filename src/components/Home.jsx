          ...
          <div>
            ...
            <div className=" xl:flex xl:gap-8 sm:grid sm:gap-6 grid gap-5 md:grid-cols-2 lg:grid-cols-2 lg:grid md:gap-5">
              <div className="h-[250px] rounded-xl pt-1 bg-white hover:bg-blue-50">
                <div className="rounded-lg px-3 bg-rose-100 mx-[40%] my-2 py-3 w-fit">
                ...
                <h1 className="text-center text-blue-600 my-2 cursor-pointer font-semibold text-lg">
                  Get Started
                </h1>
              </div>
              <div className="h-[250px] rounded-xl pt-1 bg-white hover:bg-blue-50">
                <div className="rounded-lg px-3 bg-blue-100 mx-[40%] my-2 py-3 w-fit">
                  <FaUserPlus className="text-blue-300 text-2xl" />
                </div>
                <h1 className="text-center font-semibold text-gray-500 text-lg mb-3">
                  Tell us what car you want
                </h1>
                <h1 className="text-center text-gray-500 px-7">
                  Various versions have evolved over the years, sometimes by
                  accident, sometimes on purpose
                </h1>
              </div>
              <div className="h-[250px] rounded-xl pt-1 bg-white hover:bg-blue-50">
                <div className="rounded-lg px-3 bg-green-100 mx-[40%] my-2 py-3 w-fit">
                  <FaUserPlus className="text-green-300 text22xl" />
                </div>
                <h1 className="text-center font-semibold text-gray-500 text-lg mb-3">
                  Match with seller
                </h1>
                <h1 className="text-center text-gray-500 px-3">
            ...
            <h1 className="text-3xl my-5 font-semibold text-slate-700">
              Our Blog
            </h1>
