                ...
                <div className='px-6'>
                    ...
                    <div className='flex justify-between mt-5'>
                        ...
                        <div className='flex gap-3'>
                            <div className='w-[40px] h-[40px] flex items-center justify-center bg-blue-200 sm:py-3 md:py-2 lg:py-4 rounded-full'><FaHeart className='text-blue-400 font-normal' /></div>
